...
exports.createMealFlexMessage = createMealFlexMessage;
exports.createWeightFlexMessage = createWeightFlexMessage;
exports.createMultipleMealTimesFlexMessage = createMultipleMealTimesFlexMessage;
// @ts-nocheck
function createMealFlexMessage(mealTypeJa, analysis, imageUrl, originalMealName, aiAdvice) {
    var _a;
    // 複数食事の場合
                        ...
                        contents: [
                            ...
                            // 右側：食事名
                            {
                                ...
                                contents: [
                                    {
                                        type: 'text',
                                        text: analysis.displayName || ((_a = analysis.foodItems) === null || _a === void 0 ? void 0 : _a[0]) || originalMealName || '食事',
                                        size: 'md',
                                        weight: 'bold',
                                        color: '#333333',
                                        wrap: true
...
// 複数食事用のFlexメッセージ
function createMultipleMealFlexMessage(mealTypeJa, analysis, imageUrl, originalMealName, aiAdvice) {
    ...
    const mealItems = analysis.meals.map((meal) => ({
        type: 'box',
        layout: 'vertical',
        margin: 'xs',
        paddingAll: '8px',
...
// 体重記録用のFlexメッセージ
function createWeightFlexMessage(weight) {
    return {
        type: 'flex',
        altText: '体重記録完了',
        contents: {
...
function createMultipleMealTimesFlexMessage(mealData, aiAdvice) {
    const mealTypeNames = {
        breakfast: '朝食',
        lunch: '昼食',
        dinner: '夕食',
...
//# sourceMappingURL=new_flex_message.js.map