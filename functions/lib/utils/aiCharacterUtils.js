...
exports.CHARACTER_PERSONAS = void 0;
exports.getCharacterPersona = getCharacterPersona;
exports.generateCharacterPrompt = generateCharacterPrompt;
exports.getCharacterLanguage = getCharacterLanguage;
exports.getLanguageInstruction = getLanguageInstruction;
// 定義済みキャラクターのペルソナ（ヘルシーくんのみ）
exports.CHARACTER_PERSONAS = {
    healthy_kun: {
        name: 'ヘルシーくん',
...
function getCharacterPersona(characterSettings) {
    return exports.CHARACTER_PERSONAS.healthy_kun;
}
// フィードバック用のプロンプトを生成
function generateCharacterPrompt(persona, context) {
...
// キャラクター設定から言語を取得
function getCharacterLanguage(characterSettings) {
    return (characterSettings === null || characterSettings === void 0 ? void 0 : characterSettings.language) || 'ja'; // デフォルト日本語
}
// 言語別の指示を取得
...
//# sourceMappingURL=aiCharacterUtils.js.map